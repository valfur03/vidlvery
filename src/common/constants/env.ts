export const CONFIG_WATCH_DIRECTORY_PATH_KEY = 'watchDirectoryPath';
export const CONFIG_PUBLIC_DIRECTORY_PATH_KEY = 'publicDirectoryPath';
export const CONFIG_VIDEOS_BASE_URL_KEY = 'videosBaseUrl';
